...
{
//    Lấy dữ liệu và hiển thị grid trên UI
    /**
...
//    gán collection cho grid
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'status',
            [
                'header' => __('Status'), //Tiêu đề cột có kèm transaltion của m2
                'index' => 'status', //mapping với tên cột trong DB
                'frame_callback' => [$this, 'decorateStatus']  // xử lý dữ liệu trước khi render html
            ]
        );
        return $this;
    }
