...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Packt_HelloWorld::subscription'); //Highlight menu tương ứng trong Admin Sidebar
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Subscriptions')); //title page
        return $resultPage;
    }
